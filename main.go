...
// 支持 Temurin / Corretto / Microsoft / Zulu / Liberica / GraalVM 等发行版。
//
// 用法:
//
//	jvm install 21
...
import (
	...
	_ "jvm/internal/provider/graalvm"   // 注册 Oracle GraalVM 适配器 (init 副作用)
...
func main() {
	...
	// 所有实现了 provider.Configurable 的适配器 (temurin/corretto/microsoft/zulu/liberica/graalvm)。
